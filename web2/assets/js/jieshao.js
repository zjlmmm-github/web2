...
option = {
    title: {text: "iHouse3D管理后台功能流图", top: 20, left: "center"},
    itemStyle: {normal: {color: "#67C23A",}, shadowBlur: 0},
    textStyle: {
        color: '#444',
        fontSize: 16,
        fontWeight: 600,
